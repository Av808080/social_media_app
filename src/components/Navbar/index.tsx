...
const Navbar = () => {
    return (
        <nav className='bg-white shadow-md shadow-slate-300'>
            <div className='h-24 px-4 2xl:64 xl:px-32 lg:px-16 md:px-8 flex justify-between items-center max-w-[1800px] mx-auto'>
                {/* Logo */}
